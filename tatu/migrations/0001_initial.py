# Generated by Django 2.0.3 on 2018-03-18 18:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', imagekit.models.fields.ProcessedImageField(default='default/avatar.png', upload_to=tatu.models.user_avatar_path)),
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='tatu.Post'),
        ),
        migrations.AddField(
            model_name='comment',
            name='poster',
